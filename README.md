---
website: "Site Institucional do Município de São João da Pesqueira"          # Entre as aspas escreve o nome do website
date: "13/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.sjpesqueira.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.sjpesqueira.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "CM de São João da Pesqueira"         # Entre as aspas escrever o nome do owner do website
